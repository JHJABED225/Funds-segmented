...
function seedData() {
  const coreNames = [
    {name:'',email:'',position:'President',role:'core'},
    {name:'',email:'',position:'Vice President',role:'core'},
    {name:'',email:'',position:'Treasurer',role:'core'},
    {name:'',email:'',position:'Secretary',role:'core'},
    {name:'',email:'',position:'Joint Secretary',role:'core'},
    {name:'',email:'',position:'Finance Officer',role:'core'},
    {name:'',email:'',position:'Auditor',role:'core'}
  ];
  const memberNames = [
    '','','','','',
    '','','','','',
